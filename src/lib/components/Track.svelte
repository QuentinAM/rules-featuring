...
<div class="card card-side bg-base-100 lg:h-52 h-40 shadow-2xl w-full">
    ...
    <div class="card-body lg:overflow-y-hidden overflow-y-auto h-full p-2 lg:p-8">
        ...
        <p><Translation id="released_on"/> {track.release_date} <Translation id="on"/> <a href={track.album_url} target="_blank" class="link link-hover inline font-semibold">{track.album_name}</a></p>
