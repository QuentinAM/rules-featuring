...
<div class="card card-side bg-base-100 lg:h-60 h-40 shadow-xl w-full">
    <figure><img src={track.images.url} class="lg:w-60 w-40" alt="feat"></figure>
    <div class="card-body lg:overflow-y-hidden overflow-y-auto h-full p-2 lg:p-8">
        ...
        {#if track.preview_url}
            <div class="card-actions justify-end lg:mt-5">
                <p>Preview</p>
